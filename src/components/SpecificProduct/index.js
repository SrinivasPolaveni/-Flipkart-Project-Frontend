...
const Index = () => {
  ...
  async function   getSimilarProducts() {
    await axios
      .get(
        `https://srinivasflipkartappbackend.onrender.com/product/?search=${product.category}&order_by=""&order=""`
      )
      .then((res) => {
  ...
  function getGrocerysData() {
    axios
      .get(`https://srinivasflipkartappbackend.onrender.com/product/${id}`)
      .then((res) => {
      ...
      <>
        ...
        >
          <div className="col-11  col-lg-8">
            ...
            <div className=" d-flex flex-column flex-md-row justify-content-around  my-3  specificCard ">
          ...
          >
            <div className="carousel-inner carousel-inner1" role="listbox">
              {similarData.map((eachProduct, index) => {
                  ...
                  return (
                    <div className={`carousel-item${index===0 ? ' active':''}`} key={eachProduct._id}>
                      <div className=" col-6 col-md-4 col-lg-3  p-1">
                        {" "}
                        <NavLink to={`/product/${eachProduct._id}`}>

...
const Index = () => {
  ...
  function getGrocerysData() {
    axios
      .get(
        `https://srinivasflipkartappbackend.onrender.com/product/?search=Stationery&order_by=${sortValue.price}`
      )
      .then((res) => {
        //console.log(res);
      ...
      <>
        <div className="row d-flex justify-content-center justify-content-md-between">
          {grocerysData.map((eachProduct) => (
            <div key={eachProduct._id} className="col-10 col-md-6 col-lg-4 ">
  ...
  return (
    <div>
      <h3 className="text-danger">Top Stationery Materials List:</h3>
